...
<div class="container mx-auto px-4 py-6">
    ...
    <a href="{{ route('pesanan.create') }}" class="tambah text-white px-4 py-2 rounded-md hover:bg-blue-600">+Tambah Pesanan</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-4 py-2 border border-gray-300">
                    <a href="{{ route('pesanan.edit', $pesanan->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600">Ubah</a>
